...
func MakePostRequest(url string, data url.Values, headers map[string]string, cookies map[string]string)(map[string]interface{}, error) {
    // formData := url.Values{}
...
func MakeGetRequest(url string, headers map[string]string, cookies map[string]string)(map[string]interface{}, error) {
